...
public class LoadBalancerLoadBalancingRulesInner {
    ...
    interface LoadBalancerLoadBalancingRulesService {
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.network.v2018_12_01.LoadBalancerLoadBalancingRules list" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.network.v2018_12_01.LoadBalancerLoadBalancingRules get" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.network.v2018_12_01.LoadBalancerLoadBalancingRules listNext" })
        @GET
