...
public class AvailableDelegationsInner {
    ...
    interface AvailableDelegationsService {
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.network.v2018_12_01.AvailableDelegations list" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.network.v2018_12_01.AvailableDelegations listNext" })
        @GET
