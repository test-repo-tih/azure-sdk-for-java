...
public class LoadBalancerBackendAddressPoolsInner {
    ...
    interface LoadBalancerBackendAddressPoolsService {
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.network.v2019_06_01.LoadBalancerBackendAddressPools list" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.network.v2019_06_01.LoadBalancerBackendAddressPools get" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.network.v2019_06_01.LoadBalancerBackendAddressPools listNext" })
        @GET
