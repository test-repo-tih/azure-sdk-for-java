...
public class AvailableResourceGroupDelegationsInner {
    ...
    interface AvailableResourceGroupDelegationsService {
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.network.v2019_06_01.AvailableResourceGroupDelegations list" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.network.v2019_06_01.AvailableResourceGroupDelegations listNext" })
        @GET
