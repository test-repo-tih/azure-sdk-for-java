...
public class AvailableEndpointServicesInner {
    ...
    interface AvailableEndpointServicesService {
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.network.v2019_06_01.AvailableEndpointServices list" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.network.v2019_06_01.AvailableEndpointServices listNext" })
        @GET
