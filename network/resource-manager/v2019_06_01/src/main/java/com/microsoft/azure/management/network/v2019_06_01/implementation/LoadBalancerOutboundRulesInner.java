...
public class LoadBalancerOutboundRulesInner {
    ...
    interface LoadBalancerOutboundRulesService {
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.network.v2019_06_01.LoadBalancerOutboundRules list" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.network.v2019_06_01.LoadBalancerOutboundRules get" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.network.v2019_06_01.LoadBalancerOutboundRules listNext" })
        @GET
