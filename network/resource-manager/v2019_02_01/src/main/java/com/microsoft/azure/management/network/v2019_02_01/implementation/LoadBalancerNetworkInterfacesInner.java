...
public class LoadBalancerNetworkInterfacesInner {
    ...
    interface LoadBalancerNetworkInterfacesService {
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.network.v2019_02_01.LoadBalancerNetworkInterfaces list" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.network.v2019_02_01.LoadBalancerNetworkInterfaces listNext" })
        @GET
