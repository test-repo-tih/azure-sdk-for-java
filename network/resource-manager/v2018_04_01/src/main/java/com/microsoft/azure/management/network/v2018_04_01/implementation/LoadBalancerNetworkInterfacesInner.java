...
public class LoadBalancerNetworkInterfacesInner {
    ...
    interface LoadBalancerNetworkInterfacesService {
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.network.v2018_04_01.LoadBalancerNetworkInterfaces list" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.network.v2018_04_01.LoadBalancerNetworkInterfaces listNext" })
        @GET
