...
import com.microsoft.azure.management.network.v2019_08_01.GetVpnSitesConfigurationRequest;
...
public class VpnSitesConfigurationsInner {
    ...
    interface VpnSitesConfigurationsService {
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.network.v2019_08_01.VpnSitesConfigurations download" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.network.v2019_08_01.VpnSitesConfigurations beginDownload" })
        @POST("subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/virtualWans/{virtualWANName}/vpnConfiguration")
