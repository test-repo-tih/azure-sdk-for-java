...
import com.microsoft.azure.management.network.v2019_08_01.VirtualWanVpnProfileParameters;
...
public class NetworkManagementClientImpl extends AzureServiceClient {
    ...
    public String userAgent() {
        return String.format("%s (%s, %s, auto-generated)", super.userAgent(), "NetworkManagementClient", "2019-08-01");
    }
    ...
    interface NetworkManagementClientService {
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.network.v2019_08_01.NetworkManagementClient checkDnsNameAvailability" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.network.v2019_08_01.NetworkManagementClient supportedSecurityProviders" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.network.v2019_08_01.NetworkManagementClient generatevirtualwanvpnserverconfigurationvpnprofile" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.network.v2019_08_01.NetworkManagementClient beginGeneratevirtualwanvpnserverconfigurationvpnprofile" })
        @POST("subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/virtualWans/{virtualWANName}/GenerateVpnProfile")
