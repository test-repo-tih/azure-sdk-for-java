...
public class ExpressRouteServiceProvidersInner {
    ...
    interface ExpressRouteServiceProvidersService {
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.network.v2018_07_01.ExpressRouteServiceProviders list" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.network.v2018_07_01.ExpressRouteServiceProviders listNext" })
        @GET
