...
public class NetworkInterfaceLoadBalancersInner {
    ...
    interface NetworkInterfaceLoadBalancersService {
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.network.v2019_04_01.NetworkInterfaceLoadBalancers list" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.network.v2019_04_01.NetworkInterfaceLoadBalancers listNext" })
        @GET
