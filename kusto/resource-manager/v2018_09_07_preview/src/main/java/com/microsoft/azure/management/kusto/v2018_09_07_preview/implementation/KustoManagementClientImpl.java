...
public class KustoManagementClientImpl extends AzureServiceClient {
    ...
    /**
     * The EventHubConnectionsInner object to access its operations.
     */
    private EventHubConnectionsInner eventHubConnections;

    /**
     * Gets the EventHubConnectionsInner object to access its operations.
     * @return the EventHubConnectionsInner object.
     */
    public EventHubConnectionsInner eventHubConnections() {
    ...
    protected void initialize() {
        ...
        this.eventHubConnections = new EventHubConnectionsInner(restClient().retrofit(), this);
    ...
    public String userAgent() {
        return String.format("%s (%s, %s, auto-generated)", super.userAgent(), "KustoManagementClient", "2018-09-07-preview");
    }
}
