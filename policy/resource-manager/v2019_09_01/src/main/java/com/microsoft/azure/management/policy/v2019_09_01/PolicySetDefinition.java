...
public interface PolicySetDefinition extends HasInner<PolicySetDefinitionInner>, Indexable, Updatable<PolicySetDefinition.Update>, Refreshable<PolicySetDefinition>, HasManager<PolicyManager> {
    ...
    interface DefinitionStages {
        ...
        interface WithPolicyDefinitionGroups {
            /**
             * Specifies policyDefinitionGroups.
        ...
        interface WithPolicyType {
             ...
             * @param policyType The type of policy definition. Possible values are NotSpecified, BuiltIn, Custom, and Static. Possible values include: 'NotSpecified', 'BuiltIn', 'Custom', 'Static'
             * @return the next definition stage
             */
         ...
         */
        interface WithCreate extends Creatable<PolicySetDefinition>, DefinitionStages.WithDescription, DefinitionStages.WithDisplayName, DefinitionStages.WithMetadata, DefinitionStages.WithParameters, DefinitionStages.WithPolicyDefinitionGroups, DefinitionStages.WithPolicyType {
        }
    }
    /**
     * The template for a PolicySetDefinition update operation, containing all the settings that can be modified.
     */
    interface Update extends Appliable<PolicySetDefinition>, UpdateStages.WithDescription, UpdateStages.WithDisplayName, UpdateStages.WithMetadata, UpdateStages.WithParameters, UpdateStages.WithPolicyDefinitionGroups, UpdateStages.WithPolicyType {
    }
