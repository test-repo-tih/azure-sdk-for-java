...
public interface TaskRun extends HasInner<TaskRunInner>, Indexable, Refreshable<TaskRun>, Updatable<TaskRun.Update>, HasManager<ContainerRegistryManager> {
    ...
    interface DefinitionStages {
        ...
        interface WithRunRequest {
             ...
             * @param runRequest the runRequest parameter value
             * @return the next definition stage
             */
        ...
        /**
         * The stage of the taskrun definition allowing to specify RunResult.
         */
        interface WithRunResult {
            /**
             * Specifies runResult.
             * @param runResult the runResult parameter value
             * @return the next definition stage
             */
            WithCreate withRunResult(RunInner runResult);
        }
         ...
         */
        interface WithCreate extends Creatable<TaskRun>, DefinitionStages.WithIdentity, DefinitionStages.WithRunRequest, DefinitionStages.WithRunResult, DefinitionStages.WithTags {
        }
    }
    /**
     * The template for a TaskRun update operation, containing all the settings that can be modified.
     */
    interface Update extends Appliable<TaskRun>, UpdateStages.WithIdentity, UpdateStages.WithRunRequest, UpdateStages.WithRunResult, UpdateStages.WithTags {
    }
    ...
    interface UpdateStages {
        ...
        /**
         * The stage of the taskrun update allowing to specify RunResult.
         */
        interface WithRunResult {
            /**
             * Specifies runResult.
             ...
             * @return the next update stage
             */
            Update withRunResult(RunInner runResult);
        }
