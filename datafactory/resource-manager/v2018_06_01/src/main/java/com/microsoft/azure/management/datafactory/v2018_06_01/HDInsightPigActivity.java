...
public class HDInsightPigActivity extends ExecutionActivity {
    ...
    /**
     * Get user specified arguments to HDInsightActivity. Type: array (or Expression with resultType array).
     *
    ...
    /**
     * Set user specified arguments to HDInsightActivity. Type: array (or Expression with resultType array).
     *
