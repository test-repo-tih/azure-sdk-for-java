...
public class AzureMySqlTableDataset extends DatasetInner {
    ...
    /**
     * Get the name of Azure MySQL database table. Type: string (or Expression with resultType string).
     *
    ...
    /**
     * Set the name of Azure MySQL database table. Type: string (or Expression with resultType string).
     *
