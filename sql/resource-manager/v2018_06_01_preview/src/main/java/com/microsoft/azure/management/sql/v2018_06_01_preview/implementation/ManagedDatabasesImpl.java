...
class ManagedDatabasesImpl extends WrapperImpl<ManagedDatabasesInner> implements ManagedDatabases {
    ...
    @Override
    public Completable completeRestoreAsync(String resourceGroupName, String managedInstanceName, String databaseName, String lastBackupName) {
        ManagedDatabasesInner client = this.inner();
        return client.completeRestoreAsync(resourceGroupName, managedInstanceName, databaseName, lastBackupName).toCompletable();
    }
