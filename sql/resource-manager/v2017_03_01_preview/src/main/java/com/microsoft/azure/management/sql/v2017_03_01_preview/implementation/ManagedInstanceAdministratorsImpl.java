...
class ManagedInstanceAdministratorsImpl extends WrapperImpl<ManagedInstanceAdministratorsInner> implements ManagedInstanceAdministrators {
    ...
    private Observable<ManagedInstanceAdministratorInner> getManagedInstanceAdministratorInnerUsingManagedInstanceAdministratorsInnerAsync(String id) {
        ...
        return client.getAsync(resourceGroupName, managedInstanceName, administratorName);
    }

    @Override
    public Observable<ManagedInstanceAdministrator> getAsync(String resourceGroupName, String managedInstanceName, String administratorName) {
        ManagedInstanceAdministratorsInner client = this.inner();
        return client.getAsync(resourceGroupName, managedInstanceName, administratorName)
    ...
    @Override
    public Completable deleteAsync(String resourceGroupName, String managedInstanceName, String administratorName) {
        ManagedInstanceAdministratorsInner client = this.inner();
        return client.deleteAsync(resourceGroupName, managedInstanceName, administratorName).toCompletable();
    }
