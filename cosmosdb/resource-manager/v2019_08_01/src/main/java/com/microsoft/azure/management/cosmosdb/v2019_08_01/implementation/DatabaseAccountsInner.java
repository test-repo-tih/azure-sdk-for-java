...
import com.microsoft.azure.management.cosmosdb.v2019_08_01.DatabaseAccountCreateParameters;
...
public class DatabaseAccountsInner implements InnerSupportsGet<DatabaseAccountGetResultsInner>, InnerSupportsDelete<Void>, InnerSupportsListing<DatabaseAccountGetResultsInner> {
    ...
    interface DatabaseAccountsService {
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.cosmosdb.v2019_08_01.DatabaseAccounts create" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.cosmosdb.v2019_08_01.DatabaseAccounts beginCreate" })
        @PUT("subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DocumentDB/databaseAccounts/{accountName}")
    ...
    public Observable<ServiceResponse<DatabaseAccountGetResultsInner>> createWithServiceResponseAsync(String resourceGroupName, String accountName, DatabaseAccountCreateParameters createParameters) {
        ...
        Observable<Response<ResponseBody>> observable = service.create(this.client.subscriptionId(), resourceGroupName, accountName, this.client.apiVersion(), createParameters, this.client.acceptLanguage(), this.client.userAgent());
        return client.getAzureClient().getPutOrPatchResultAsync(observable, new TypeToken<DatabaseAccountGetResultsInner>() { }.getType());
    }
    ...
    public Observable<ServiceResponse<DatabaseAccountGetResultsInner>> beginCreateWithServiceResponseAsync(String resourceGroupName, String accountName, DatabaseAccountCreateParameters createParameters) {
        ...
        Validator.validate(createParameters);
        return service.beginCreate(this.client.subscriptionId(), resourceGroupName, accountName, this.client.apiVersion(), createParameters, this.client.acceptLanguage(), this.client.userAgent())
            .flatMap(new Func1<Response<ResponseBody>, Observable<ServiceResponse<DatabaseAccountGetResultsInner>>>() {
                @Override
                public Observable<ServiceResponse<DatabaseAccountGetResultsInner>> call(Response<ResponseBody> response) {
                    try {
