 ...
 */
@JsonFlatten
public class DatabaseAccountCreateParameters extends ARMResourceProperties {
    /**
     ...
     * @return the DatabaseAccountCreateParameters object itself.
     */
    public DatabaseAccountCreateParameters withKind(DatabaseAccountKind kind) {
        this.kind = kind;
        return this;
    }
     ...
     * @return the DatabaseAccountCreateParameters object itself.
     */
    public DatabaseAccountCreateParameters withConsistencyPolicy(ConsistencyPolicy consistencyPolicy) {
     ...
     * @return the DatabaseAccountCreateParameters object itself.
     */
    public DatabaseAccountCreateParameters withLocations(List<Location> locations) {
     ...
     * @return the DatabaseAccountCreateParameters object itself.
     */
    public DatabaseAccountCreateParameters withDatabaseAccountOfferType(String databaseAccountOfferType) {
     ...
     * @return the DatabaseAccountCreateParameters object itself.
     */
    public DatabaseAccountCreateParameters withIpRangeFilter(String ipRangeFilter) {
     ...
     * @return the DatabaseAccountCreateParameters object itself.
     */
    public DatabaseAccountCreateParameters withIsVirtualNetworkFilterEnabled(Boolean isVirtualNetworkFilterEnabled) {
     ...
     * @return the DatabaseAccountCreateParameters object itself.
     */
    public DatabaseAccountCreateParameters withEnableAutomaticFailover(Boolean enableAutomaticFailover) {
     ...
     * @return the DatabaseAccountCreateParameters object itself.
     */
    public DatabaseAccountCreateParameters withCapabilities(List<Capability> capabilities) {
     ...
     * @return the DatabaseAccountCreateParameters object itself.
     */
    public DatabaseAccountCreateParameters withVirtualNetworkRules(List<VirtualNetworkRule> virtualNetworkRules) {
     ...
     * @return the DatabaseAccountCreateParameters object itself.
     */
    public DatabaseAccountCreateParameters withEnableMultipleWriteLocations(Boolean enableMultipleWriteLocations) {
     ...
     * @return the DatabaseAccountCreateParameters object itself.
     */
    public DatabaseAccountCreateParameters withEnableCassandraConnector(Boolean enableCassandraConnector) {
     ...
     * @return the DatabaseAccountCreateParameters object itself.
     */
    public DatabaseAccountCreateParameters withConnectorOffer(ConnectorOffer connectorOffer) {
     ...
     * @return the DatabaseAccountCreateParameters object itself.
     */
    public DatabaseAccountCreateParameters withDisableKeyBasedMetadataWriteAccess(Boolean disableKeyBasedMetadataWriteAccess) {
