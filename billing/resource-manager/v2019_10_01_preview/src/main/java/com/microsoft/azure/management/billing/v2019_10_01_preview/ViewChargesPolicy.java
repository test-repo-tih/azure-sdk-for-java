...
public final class ViewChargesPolicy extends ExpandableStringEnum<ViewChargesPolicy> {
    /** Static value None for ViewChargesPolicy. */
    public static final ViewChargesPolicy NONE = fromString("None");

    /** Static value SubscriptionOwner for ViewChargesPolicy. */
    public static final ViewChargesPolicy SUBSCRIPTION_OWNER = fromString("SubscriptionOwner");
