...
public class TransactionsInner {
     ...
     */
    public PagedList<TransactionInner> listByCustomer(final String billingAccountName, final String customerName, final String startDate, final String endDate) {
        ServiceResponse<Page<TransactionInner>> response = listByCustomerSinglePageAsync(billingAccountName, customerName, startDate, endDate).toBlocking().single();
     ...
     */
    public ServiceFuture<List<TransactionInner>> listByCustomerAsync(final String billingAccountName, final String customerName, final String startDate, final String endDate, final ListOperationCallback<TransactionInner> serviceCallback) {
        return AzureServiceFuture.fromPageResponse(
            listByCustomerSinglePageAsync(billingAccountName, customerName, startDate, endDate),
     ...
     */
    public Observable<Page<TransactionInner>> listByCustomerAsync(final String billingAccountName, final String customerName, final String startDate, final String endDate) {
        return listByCustomerWithServiceResponseAsync(billingAccountName, customerName, startDate, endDate)
     ...
     * @return the observable to the PagedList&lt;TransactionInner&gt; object
     */
    public Observable<ServiceResponse<Page<TransactionInner>>> listByCustomerWithServiceResponseAsync(final String billingAccountName, final String customerName, final String startDate, final String endDate) {
        return listByCustomerSinglePageAsync(billingAccountName, customerName, startDate, endDate)
     ...
     */
    public Observable<ServiceResponse<Page<TransactionInner>>> listByCustomerSinglePageAsync(final String billingAccountName, final String customerName, final String startDate, final String endDate) {
        ...
        return service.listByCustomer(billingAccountName, customerName, this.client.apiVersion(), startDate, endDate, filter, this.client.acceptLanguage(), this.client.userAgent())
     ...
     * @return the PagedList&lt;TransactionInner&gt; object if successful.
     */
    public PagedList<TransactionInner> listByCustomer(final String billingAccountName, final String customerName, final String startDate, final String endDate, final String filter) {
        ServiceResponse<Page<TransactionInner>> response = listByCustomerSinglePageAsync(billingAccountName, customerName, startDate, endDate, filter).toBlocking().single();
        return new PagedList<TransactionInner>(response.body()) {
            @Override
            public Page<TransactionInner> nextPage(String nextPageLink) {
                return listByCustomerNextSinglePageAsync(nextPageLink).toBlocking().single().body();
     ...
     * @return the {@link ServiceFuture} object
     */
    public ServiceFuture<List<TransactionInner>> listByCustomerAsync(final String billingAccountName, final String customerName, final String startDate, final String endDate, final String filter, final ListOperationCallback<TransactionInner> serviceCallback) {
        return AzureServiceFuture.fromPageResponse(
            listByCustomerSinglePageAsync(billingAccountName, customerName, startDate, endDate, filter),
            new Func1<String, Observable<ServiceResponse<Page<TransactionInner>>>>() {
                @Override
                public Observable<ServiceResponse<Page<TransactionInner>>> call(String nextPageLink) {
                    return listByCustomerNextSinglePageAsync(nextPageLink);
     ...
     * @return the observable to the PagedList&lt;TransactionInner&gt; object
     */
    public Observable<Page<TransactionInner>> listByCustomerAsync(final String billingAccountName, final String customerName, final String startDate, final String endDate, final String filter) {
        return listByCustomerWithServiceResponseAsync(billingAccountName, customerName, startDate, endDate, filter)
            .map(new Func1<ServiceResponse<Page<TransactionInner>>, Page<TransactionInner>>() {
                @Override
                public Page<TransactionInner> call(ServiceResponse<Page<TransactionInner>> response) {
                    return response.body();
     ...
     * @return the observable to the PagedList&lt;TransactionInner&gt; object
     */
    public Observable<ServiceResponse<Page<TransactionInner>>> listByCustomerWithServiceResponseAsync(final String billingAccountName, final String customerName, final String startDate, final String endDate, final String filter) {
        return listByCustomerSinglePageAsync(billingAccountName, customerName, startDate, endDate, filter)
            .concatMap(new Func1<ServiceResponse<Page<TransactionInner>>, Observable<ServiceResponse<Page<TransactionInner>>>>() {
                @Override
                public Observable<ServiceResponse<Page<TransactionInner>>> call(ServiceResponse<Page<TransactionInner>> page) {
                    String nextPageLink = page.body().nextPageLink();
     ...
     * @return the PagedList&lt;TransactionInner&gt; object wrapped in {@link ServiceResponse} if successful.
     */
    public Observable<ServiceResponse<Page<TransactionInner>>> listByCustomerSinglePageAsync(final String billingAccountName, final String customerName, final String startDate, final String endDate, final String filter) {
        if (billingAccountName == null) {
            throw new IllegalArgumentException("Parameter billingAccountName is required and cannot be null.");
        }
        if (customerName == null) {
     ...
     * @return the PagedList&lt;TransactionInner&gt; object if successful.
     */
    public PagedList<TransactionInner> listByBillingAccount(final String billingAccountName, final String startDate, final String endDate) {
        ServiceResponse<Page<TransactionInner>> response = listByBillingAccountSinglePageAsync(billingAccountName, startDate, endDate).toBlocking().single();
        return new PagedList<TransactionInner>(response.body()) {
            @Override
            public Page<TransactionInner> nextPage(String nextPageLink) {
     ...
     * @return the {@link ServiceFuture} object
     */
    public ServiceFuture<List<TransactionInner>> listByBillingAccountAsync(final String billingAccountName, final String startDate, final String endDate, final ListOperationCallback<TransactionInner> serviceCallback) {
        return AzureServiceFuture.fromPageResponse(
            listByBillingAccountSinglePageAsync(billingAccountName, startDate, endDate),
            new Func1<String, Observable<ServiceResponse<Page<TransactionInner>>>>() {
                @Override
                public Observable<ServiceResponse<Page<TransactionInner>>> call(String nextPageLink) {
     ...
     * @return the observable to the PagedList&lt;TransactionInner&gt; object
     */
    public Observable<Page<TransactionInner>> listByBillingAccountAsync(final String billingAccountName, final String startDate, final String endDate) {
        return listByBillingAccountWithServiceResponseAsync(billingAccountName, startDate, endDate)
            .map(new Func1<ServiceResponse<Page<TransactionInner>>, Page<TransactionInner>>() {
                @Override
                public Page<TransactionInner> call(ServiceResponse<Page<TransactionInner>> response) {
                    return response.body();
     ...
     * @return the observable to the PagedList&lt;TransactionInner&gt; object
     */
    public Observable<ServiceResponse<Page<TransactionInner>>> listByBillingAccountWithServiceResponseAsync(final String billingAccountName, final String startDate, final String endDate) {
        return listByBillingAccountSinglePageAsync(billingAccountName, startDate, endDate)
            .concatMap(new Func1<ServiceResponse<Page<TransactionInner>>, Observable<ServiceResponse<Page<TransactionInner>>>>() {
                @Override
                public Observable<ServiceResponse<Page<TransactionInner>>> call(ServiceResponse<Page<TransactionInner>> page) {
                    String nextPageLink = page.body().nextPageLink();
     ...
     * @return the PagedList&lt;TransactionInner&gt; object wrapped in {@link ServiceResponse} if successful.
     */
    public Observable<ServiceResponse<Page<TransactionInner>>> listByBillingAccountSinglePageAsync(final String billingAccountName, final String startDate, final String endDate) {
        if (billingAccountName == null) {
            throw new IllegalArgumentException("Parameter billingAccountName is required and cannot be null.");
        }
        if (this.client.apiVersion() == null) {
        ...
        final String filter = null;
        return service.listByBillingAccount(billingAccountName, this.client.apiVersion(), startDate, endDate, filter, this.client.acceptLanguage(), this.client.userAgent())
            .flatMap(new Func1<Response<ResponseBody>, Observable<ServiceResponse<Page<TransactionInner>>>>() {
                @Override
                public Observable<ServiceResponse<Page<TransactionInner>>> call(Response<ResponseBody> response) {
                    try {
     ...
     * @return the PagedList&lt;TransactionInner&gt; object if successful.
     */
    public PagedList<TransactionInner> listByBillingAccount(final String billingAccountName, final String startDate, final String endDate, final String filter) {
        ServiceResponse<Page<TransactionInner>> response = listByBillingAccountSinglePageAsync(billingAccountName, startDate, endDate, filter).toBlocking().single();
        return new PagedList<TransactionInner>(response.body()) {
            @Override
            public Page<TransactionInner> nextPage(String nextPageLink) {
                return listByBillingAccountNextSinglePageAsync(nextPageLink).toBlocking().single().body();
     ...
     * @return the {@link ServiceFuture} object
     */
    public ServiceFuture<List<TransactionInner>> listByBillingAccountAsync(final String billingAccountName, final String startDate, final String endDate, final String filter, final ListOperationCallback<TransactionInner> serviceCallback) {
        return AzureServiceFuture.fromPageResponse(
            listByBillingAccountSinglePageAsync(billingAccountName, startDate, endDate, filter),
            new Func1<String, Observable<ServiceResponse<Page<TransactionInner>>>>() {
                @Override
                public Observable<ServiceResponse<Page<TransactionInner>>> call(String nextPageLink) {
                    return listByBillingAccountNextSinglePageAsync(nextPageLink);
     ...
     * @return the observable to the PagedList&lt;TransactionInner&gt; object
     */
    public Observable<Page<TransactionInner>> listByBillingAccountAsync(final String billingAccountName, final String startDate, final String endDate, final String filter) {
        return listByBillingAccountWithServiceResponseAsync(billingAccountName, startDate, endDate, filter)
            .map(new Func1<ServiceResponse<Page<TransactionInner>>, Page<TransactionInner>>() {
                @Override
                public Page<TransactionInner> call(ServiceResponse<Page<TransactionInner>> response) {
                    return response.body();
     ...
     * @return the observable to the PagedList&lt;TransactionInner&gt; object
     */
    public Observable<ServiceResponse<Page<TransactionInner>>> listByBillingAccountWithServiceResponseAsync(final String billingAccountName, final String startDate, final String endDate, final String filter) {
        return listByBillingAccountSinglePageAsync(billingAccountName, startDate, endDate, filter)
            .concatMap(new Func1<ServiceResponse<Page<TransactionInner>>, Observable<ServiceResponse<Page<TransactionInner>>>>() {
                @Override
                public Observable<ServiceResponse<Page<TransactionInner>>> call(ServiceResponse<Page<TransactionInner>> page) {
                    String nextPageLink = page.body().nextPageLink();
     ...
     * @return the PagedList&lt;TransactionInner&gt; object wrapped in {@link ServiceResponse} if successful.
     */
    public Observable<ServiceResponse<Page<TransactionInner>>> listByBillingAccountSinglePageAsync(final String billingAccountName, final String startDate, final String endDate, final String filter) {
        if (billingAccountName == null) {
            throw new IllegalArgumentException("Parameter billingAccountName is required and cannot be null.");
        }
        if (this.client.apiVersion() == null) {
     ...
     */
    public TransactionListResultInner listByBillingProfile(String billingAccountName, String billingProfileName, String startDate, String endDate) {
        return listByBillingProfileWithServiceResponseAsync(billingAccountName, billingProfileName, startDate, endDate).toBlocking().single().body();
    }
     ...
     * @return the {@link ServiceFuture} object
     */
    public ServiceFuture<TransactionListResultInner> listByBillingProfileAsync(String billingAccountName, String billingProfileName, String startDate, String endDate, final ServiceCallback<TransactionListResultInner> serviceCallback) {
        return ServiceFuture.fromResponse(listByBillingProfileWithServiceResponseAsync(billingAccountName, billingProfileName, startDate, endDate), serviceCallback);
    }
     ...
     */
    public Observable<TransactionListResultInner> listByBillingProfileAsync(String billingAccountName, String billingProfileName, String startDate, String endDate) {
        return listByBillingProfileWithServiceResponseAsync(billingAccountName, billingProfileName, startDate, endDate).map(new Func1<ServiceResponse<TransactionListResultInner>, TransactionListResultInner>() {
            @Override
     ...
     * @return the observable to the TransactionListResultInner object
     */
    public Observable<ServiceResponse<TransactionListResultInner>> listByBillingProfileWithServiceResponseAsync(String billingAccountName, String billingProfileName, String startDate, String endDate) {
        if (billingAccountName == null) {
            throw new IllegalArgumentException("Parameter billingAccountName is required and cannot be null.");
        }
        ...
        final String filter = null;
        return service.listByBillingProfile(billingAccountName, billingProfileName, this.client.apiVersion(), startDate, endDate, filter, this.client.acceptLanguage(), this.client.userAgent())
     ...
     * @return the TransactionListResultInner object if successful.
     */
    public TransactionListResultInner listByBillingProfile(String billingAccountName, String billingProfileName, String startDate, String endDate, String filter) {
        return listByBillingProfileWithServiceResponseAsync(billingAccountName, billingProfileName, startDate, endDate, filter).toBlocking().single().body();
    }
     ...
     * @return the {@link ServiceFuture} object
     */
    public ServiceFuture<TransactionListResultInner> listByBillingProfileAsync(String billingAccountName, String billingProfileName, String startDate, String endDate, String filter, final ServiceCallback<TransactionListResultInner> serviceCallback) {
        return ServiceFuture.fromResponse(listByBillingProfileWithServiceResponseAsync(billingAccountName, billingProfileName, startDate, endDate, filter), serviceCallback);
    }
     ...
     * @return the observable to the TransactionListResultInner object
     */
    public Observable<TransactionListResultInner> listByBillingProfileAsync(String billingAccountName, String billingProfileName, String startDate, String endDate, String filter) {
        return listByBillingProfileWithServiceResponseAsync(billingAccountName, billingProfileName, startDate, endDate, filter).map(new Func1<ServiceResponse<TransactionListResultInner>, TransactionListResultInner>() {
            @Override
            public TransactionListResultInner call(ServiceResponse<TransactionListResultInner> response) {
                return response.body();
            }
     ...
     * @return the observable to the TransactionListResultInner object
     */
    public Observable<ServiceResponse<TransactionListResultInner>> listByBillingProfileWithServiceResponseAsync(String billingAccountName, String billingProfileName, String startDate, String endDate, String filter) {
        if (billingAccountName == null) {
            throw new IllegalArgumentException("Parameter billingAccountName is required and cannot be null.");
        }
        if (billingProfileName == null) {
     ...
     * @return the TransactionListResultInner object if successful.
     */
    public TransactionListResultInner listByInvoiceSection(String billingAccountName, String billingProfileName, String invoiceSectionName, String startDate, String endDate) {
        return listByInvoiceSectionWithServiceResponseAsync(billingAccountName, billingProfileName, invoiceSectionName, startDate, endDate).toBlocking().single().body();
    }
     ...
     * @return the {@link ServiceFuture} object
     */
    public ServiceFuture<TransactionListResultInner> listByInvoiceSectionAsync(String billingAccountName, String billingProfileName, String invoiceSectionName, String startDate, String endDate, final ServiceCallback<TransactionListResultInner> serviceCallback) {
        return ServiceFuture.fromResponse(listByInvoiceSectionWithServiceResponseAsync(billingAccountName, billingProfileName, invoiceSectionName, startDate, endDate), serviceCallback);
    }
     ...
     * @return the observable to the TransactionListResultInner object
     */
    public Observable<TransactionListResultInner> listByInvoiceSectionAsync(String billingAccountName, String billingProfileName, String invoiceSectionName, String startDate, String endDate) {
        return listByInvoiceSectionWithServiceResponseAsync(billingAccountName, billingProfileName, invoiceSectionName, startDate, endDate).map(new Func1<ServiceResponse<TransactionListResultInner>, TransactionListResultInner>() {
            @Override
            public TransactionListResultInner call(ServiceResponse<TransactionListResultInner> response) {
                return response.body();
            }
     ...
     * @return the observable to the TransactionListResultInner object
     */
    public Observable<ServiceResponse<TransactionListResultInner>> listByInvoiceSectionWithServiceResponseAsync(String billingAccountName, String billingProfileName, String invoiceSectionName, String startDate, String endDate) {
        if (billingAccountName == null) {
            throw new IllegalArgumentException("Parameter billingAccountName is required and cannot be null.");
        }
        if (billingProfileName == null) {
        ...
        final String filter = null;
        return service.listByInvoiceSection(billingAccountName, billingProfileName, invoiceSectionName, this.client.apiVersion(), startDate, endDate, filter, this.client.acceptLanguage(), this.client.userAgent())
            .flatMap(new Func1<Response<ResponseBody>, Observable<ServiceResponse<TransactionListResultInner>>>() {
                @Override
                public Observable<ServiceResponse<TransactionListResultInner>> call(Response<ResponseBody> response) {
                    try {
     ...
     * @return the TransactionListResultInner object if successful.
     */
    public TransactionListResultInner listByInvoiceSection(String billingAccountName, String billingProfileName, String invoiceSectionName, String startDate, String endDate, String filter) {
        return listByInvoiceSectionWithServiceResponseAsync(billingAccountName, billingProfileName, invoiceSectionName, startDate, endDate, filter).toBlocking().single().body();
    }
     ...
     * @return the {@link ServiceFuture} object
     */
    public ServiceFuture<TransactionListResultInner> listByInvoiceSectionAsync(String billingAccountName, String billingProfileName, String invoiceSectionName, String startDate, String endDate, String filter, final ServiceCallback<TransactionListResultInner> serviceCallback) {
        return ServiceFuture.fromResponse(listByInvoiceSectionWithServiceResponseAsync(billingAccountName, billingProfileName, invoiceSectionName, startDate, endDate, filter), serviceCallback);
    }
     ...
     * @return the observable to the TransactionListResultInner object
     */
    public Observable<TransactionListResultInner> listByInvoiceSectionAsync(String billingAccountName, String billingProfileName, String invoiceSectionName, String startDate, String endDate, String filter) {
        return listByInvoiceSectionWithServiceResponseAsync(billingAccountName, billingProfileName, invoiceSectionName, startDate, endDate, filter).map(new Func1<ServiceResponse<TransactionListResultInner>, TransactionListResultInner>() {
            @Override
            public TransactionListResultInner call(ServiceResponse<TransactionListResultInner> response) {
                return response.body();
            }
     ...
     * @return the observable to the TransactionListResultInner object
     */
    public Observable<ServiceResponse<TransactionListResultInner>> listByInvoiceSectionWithServiceResponseAsync(String billingAccountName, String billingProfileName, String invoiceSectionName, String startDate, String endDate, String filter) {
        if (billingAccountName == null) {
            throw new IllegalArgumentException("Parameter billingAccountName is required and cannot be null.");
        }
        if (billingProfileName == null) {
