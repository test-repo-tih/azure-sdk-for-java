...
import com.microsoft.azure.management.advisor.v2016_07_12_preview.RecommendationsGenerateeHeaders;
...
public class RecommendationsInner {
    ...
    interface RecommendationsService {
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.advisor.v2016_07_12_preview.Recommendations generatee" })
        @POST("subscriptions/{subscriptionId}/providers/Microsoft.Advisor/generateRecommendations")
        Observable<Response<ResponseBody>> generatee(@Path("subscriptionId") String subscriptionId, @Query("api-version") String apiVersion, @Header("accept-language") String acceptLanguage, @Header("User-Agent") String userAgent);
    ...
    public void generatee() {
        generateeWithServiceResponseAsync().toBlocking().single().body();
    }
     ...
     */
    public ServiceFuture<Void> generateeAsync(final ServiceCallback<Void> serviceCallback) {
        return ServiceFuture.fromHeaderResponse(generateeWithServiceResponseAsync(), serviceCallback);
    }
     ...
     */
    public Observable<Void> generateeAsync() {
        return generateeWithServiceResponseAsync().map(new Func1<ServiceResponseWithHeaders<Void, RecommendationsGenerateeHeaders>, Void>() {
            @Override
            public Void call(ServiceResponseWithHeaders<Void, RecommendationsGenerateeHeaders> response) {
     ...
     * @return the {@link ServiceResponseWithHeaders} object if successful.
     */
    public Observable<ServiceResponseWithHeaders<Void, RecommendationsGenerateeHeaders>> generateeWithServiceResponseAsync() {
        ...
        return service.generatee(this.client.subscriptionId(), this.client.apiVersion(), this.client.acceptLanguage(), this.client.userAgent())
            .flatMap(new Func1<Response<ResponseBody>, Observable<ServiceResponseWithHeaders<Void, RecommendationsGenerateeHeaders>>>() {
                @Override
                public Observable<ServiceResponseWithHeaders<Void, RecommendationsGenerateeHeaders>> call(Response<ResponseBody> response) {
                    try {
                        ServiceResponseWithHeaders<Void, RecommendationsGenerateeHeaders> clientResponse = generateeDelegate(response);
    ...
    private ServiceResponseWithHeaders<Void, RecommendationsGenerateeHeaders> generateeDelegate(Response<ResponseBody> response) throws CloudException, IOException, IllegalArgumentException {
        return this.client.restClient().responseBuilderFactory().<Void, CloudException>newInstance(this.client.serializerAdapter())
                .register(202, new TypeToken<Void>() { }.getType())
                .registerError(CloudException.class)
                .buildWithHeaders(response, RecommendationsGenerateeHeaders.class);
    }
