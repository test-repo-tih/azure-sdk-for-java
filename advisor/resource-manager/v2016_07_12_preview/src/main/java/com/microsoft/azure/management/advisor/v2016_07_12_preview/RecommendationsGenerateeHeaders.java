...
/**
 * Defines headers for Generatee operation.
 */
public class RecommendationsGenerateeHeaders {
    /**
     ...
     * @return the RecommendationsGenerateeHeaders object itself.
     */
    public RecommendationsGenerateeHeaders withLocation(String location) {
     ...
     * @return the RecommendationsGenerateeHeaders object itself.
     */
    public RecommendationsGenerateeHeaders withRetryAfter(String retryAfter) {
